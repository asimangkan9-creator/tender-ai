...
Provide a concise recommendation with reasoning."""
    ...
    try:
        ...
        return f"AI is currently unavailable. Found {len(tenders)} tenders matching '{query}'. Please install Ollama for AI recommendations."
...
async def chat_with_ai(message: str) -> str:
    try:
        ...
        return "AI is currently unavailable. Please install Ollama (ollama.com) and pull llama3.2 model."